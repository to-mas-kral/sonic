...
private:
    ...
    Material
    load_conductor_material(Scene &sc, const pugi::xml_node &bsdf) const;

    Material
    load_dielectric_material(Scene &sc, const pugi::xml_node &bsdf) const;

    Material
    load_roughconductor_material(Scene &sc, const pugi::xml_node &bsdf) const;
