...
struct Tile {
    static Tile make_from_tile_index(u32 tile_index, uvec2 dimensions) {
...
public:
    ...
    void schedule_stop() { should_stop = true; };
    ...
    void render() {
        while (!should_stop) {
            ...
            if (tile_index < tiles_per_frame) {
                ...
                // FIXME: not 100% sure, but I think this requires a sync point to be actually correct
